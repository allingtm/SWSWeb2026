          ...
          >
            <article className="relative h-full min-h-[400px] lg:min-h-[500px] overflow-hidden rounded-2xl">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-8">
                ...
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold leading-tight text-white mb-3 group-hover:text-primary transition-colors">
                  {mainPost.title}
                </h2>
                {mainPost.excerpt && (
              ...
              >
                <article className="relative h-full min-h-[180px] lg:min-h-0 overflow-hidden rounded-xl">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4">
                    ...
                    <h3 className="text-lg md:text-xl font-semibold text-white group-hover:text-primary transition-colors line-clamp-2">
                      {post.title}
                    </h3>
